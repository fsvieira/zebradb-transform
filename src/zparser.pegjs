...
definition = _ funcDeclaration:funcDeclaration _ {
...
jsonValue = concatString / json / expression
...
string
  = '"' chars:DoubleStringCharacter* '"' { return {type: 'string', data: chars.join('')}; }
